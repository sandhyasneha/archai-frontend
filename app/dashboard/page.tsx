...
export default async function DashboardPage() {
  ...
  const stats = [
    { label: 'Projects', value: '0', delta: 'No projects yet' },
    { label: 'Cloud spend (est.)', value: '$0', delta: 'Across all clouds' },
    { label: 'Compliance score', value: '—', delta: 'Run a blueprint first' },
    { label: 'Blueprints generated', value: '0', delta: 'This billing cycle' },
  ]
    ...
    <div className="flex h-screen w-full bg-white overflow-hidden">
      <nav className="w-[234px] flex-shrink-0 border-r border-gray-100 flex flex-col h-screen">
        <div className="px-4 py-5 border-b border-gray-100 flex items-center gap-2.5">
          <div className="w-6 h-6 bg-black rounded flex items-center justify-center text-white text-xs font-bold flex-shrink-0">
            A
          </div>
        ...
        <div className="flex-1 px-2.5 py-3 flex flex-col gap-0.5 overflow-y-auto">
          ...
          <p className="text-[10px] font-semibold uppercase tracking-widest text-gray-400 px-2 pt-4 pb-1">
            Configuration
          </p>
          ...
          <div className="grid grid-cols-4 gap-3.5 mb-7">
            {stats.map((s) => (
              <div key={s.label} className="border border-gray-100 rounded-xl p-4">
                ...
                <div className="text-3xl font-medium text-black tracking-tight mb-1.5">
                  {s.value}
                </div>
          ...
          <div className="grid grid-cols-3 gap-5">
            <div className="col-span-2 border border-gray-100 rounded-xl overflow-hidden">
              <div className="px-5 py-4 border-b border-gray-50 flex items-center justify-between">
                ...
                <a href="/project/new" className="text-xs text-gray-400 hover:text-black transition-colors">
                  + New project
                </a>
              </div>
              <div className="flex flex-col items-center justify-center py-16 text-center px-8">
                <div className="text-3xl text-gray-200 mb-4">⌂</div>
                <div className="text-sm font-medium text-black mb-1">No projects yet</div>
            ...
            <div className="border border-gray-100 rounded-xl overflow-hidden">
              ...
              <div className="flex flex-col items-center justify-center py-16 text-center px-5">
                ...
                <p className="text-xs text-gray-400">
                  Agent runs, blueprint saves, and exports will appear here.
                </p>
              </div>
            </div>
          </div>
